                            ...
                            <div class="card-body">
                                ...
                                <b-tabs pills card>
                                    <b-tab :title="item.name" class="folder-tab" v-for="(item, key) in imageFolder"
                                           :key="key" @click="folder = item.code; getImage()">
                                        ...
                                        <div v-if="!imageList" class="text-center">
            ...
            <div class="d-block text-center">
                <form class="form-horizontal">
                    <div class="card-body">
                        ...
                        <div class="form-group row text-left">
                            <label for="name" class="col-sm-3">{{ $t('media.createdAt') }} : </label>
                            <div class="col-sm-9">
...
<script>
    export default {
        ...
        mounted() {
	        ...
	        //permission
	        this.controlPermission = this.$store.state.permission.media.image
        ...
        methods: {
            ...
            getSetting: function () {
                ...
                this.$store.dispatch('authRequest', request).then((response) => {
                    this.imageFolder = response

                    //預設第一個資料夾
                    this.folder = response[0].code
            ...
            uploadImage: function () {
                ...
                this.uploadHeaders.Authorization = 'Bearer ' + JSON.parse(localStorage.getItem('auth')).token
                this.uploadHeaders.hostcode = localStorage.getItem('hostcode');
                this.uploadHeaders['X-FORWARDED-HOST'] = process.env.VUE_APP_ADMIN_DOMAIN;
            ...
            createFolder: function () {
                ...
                this.$store.dispatch('authRequest', request).then((response) => {
                    ...
                    this.sentData.code = null;
                    this.sentData.name = null;
