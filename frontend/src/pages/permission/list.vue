                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table table-hover table-striped text-nowrap table-bordered">
                            ...
                            <tr v-for="(data, index) in permissionList" :key="index">
                                <td v-if="controlPermission === 'E'"><input type="checkbox" :value="data.permission_id" v-model="selected" /></td>
                                ...
                                <td>
                                    <router-link :to="{ name: 'permissionEdit', params: { id: data.permission_id }}" class="btn btn-primary">
