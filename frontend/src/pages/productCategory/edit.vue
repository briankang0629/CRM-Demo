                            ...
                            <div class="card-body">
                                <b-tabs content-class="mt-3"  pills card>
                                                        ...
                                                        <b-tab :title="$t('language.' + data.language)" v-for="(data, index) in product.detail" :key="index">
                                                            <div class="card-body">
                                                                ...
                                                                <div class="form-group row text-left">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control" id="meta_title" v-model="product.detail[index].meta_title"
                                                                ...
                                                                <div class="form-group row text-left">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control" id="meta_keyword" v-model="product.detail[index].meta_keyword"
                                                                ...
                                                                <div class="form-group row text-left">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control" id="meta_description" v-model="product.detail[index].meta_description"
                                    ...
                                    <b-tab :title="$t('product.productOption')">
                                        ...
                                        <b-card no-body>
                                            <b-tabs pills card>
                                                <b-tab :title="getNameByLanguage(option.detail)" v-for="(option, sort) in product.product_option" :key="sort">
                                                    <!--<div class="mt-2 mb-3">-->
                                                        <!--<div class="col-12">-->
                    ...
                    <form class="form-horizontal">
                        <div class="table-responsive">
                            <table class="table table-hover table-striped table-bordered text-nowrap">
                                ...
                                <tbody>
                                    <tr v-for="(option, index) in product.product_option" :key="index">
    ...
    export default {
        ...
        methods: {
            ...
            addOption( type , data ) {
                switch (type) {
                    case 'option':
                        this.product.product_option.push({
                            multiple: "N",
            ...
            removeOption( type , index = 0 , option = [] ) {
                ...
                switch (type) {
                    case 'option':
                        //詢問刪除
                        if(this.product.product_option[index].product_optionId) {
                            this.$Swal.ask(askSetting).then((result) => {
                                if (result.isConfirmed) {
                                    this.isLoading = true
                                    let productOptionId = this.product.product_option[index].product_option_id
                                    ...
                                    this.$store.dispatch('authRequest', request).then((response) => {
                                        ...
                                        this.product.product_option.splice(index , 1)
